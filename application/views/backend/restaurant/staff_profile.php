		...
		<div class="nav-tabs-custom">
			...
			<div class="tab-content">
				<div class="active tab-pane" id="activity">
					<!-- Post -->
					<div class="post">
						<form class="" action="<?= base_url('admin/restaurant/update_staff_profile') ?>" method="post">
							<?=  csrf();?>
				...
				<div class="tab-pane" id="settings">
					<form class="form-horizontal " action="<?= base_url('admin/restaurant/change_pass') ?>" method="post" id="change_pass_form">
						<!-- csrf token -->
						   <?= csrf(); ?>
		...
		<div class="box box-info">
			...
			<div class="box-body" >
				<div class="user_profile_img">
					<form action="<?= base_url('admin/restaurant/upload_profile'); ?>" class="upload_img" method="post" enctype= "multipart/form-data"> 
						<!-- csrf token -->
						   <?= csrf(); ?>
