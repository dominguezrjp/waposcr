	...
	<div class="col-md-7">
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title"><?= !empty(lang('staff_list'))?lang('staff_list'):"Staff List";?> &nbsp; &nbsp; <a href="<?= base_url('admin/adminstaff/staff/') ;?>" class="btn btn-info info-light btn-flat"><i class="fa fa-plus"></i> &nbsp;<?= !empty(lang('add_new'))?lang('add_new'):"Add New Table";?> </a></h3>
			...
			<div class="box-body">
				<div class="upcoming_events">
					<div class="table-responsive">
						<table class="table table-bordered data_tables">
							<thead>
								<tr>
							...
							<tbody>
								<?php $i=1; foreach ($staff_list as $row): ?>
									<tr>
										...
										<td>
											<a href="<?= base_url("admin/adminstaff/activities/{$row['id']}");?>" class="btn btn-flat btn-primary btn-sm"> <i class="fa fa-eye"></i> </a>


											<a href="javascript:;" title="<?= lang('reset_password');?>" data-toggle="tooltip" data-placement="top" class="btn btn-flat btn-warning btn-sm staff_reset_password" data-id="<?= $row['id'];?>"> <i class="fa fa-lock"></i> </a>

											<a href="<?= base_url('admin/adminstaff/edit_staff/'.html_escape($row['id'])); ?>" class="btn btn-info btn-sm"> <i class="fa fa-edit"></i> <?= !empty(lang('edit'))?lang('edit'):"edit";?></a>
								...
								<table class="table table-bordered">
									...
									<tbody>
										<?php $i=1; foreach ($permission_list as $row): ?>
											<tr>
												<td><?= $i;?></td>
												<td><p><?= html_escape($row['title']); ?></p></td>
