	...
	<div class="col-md-7">
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title"><?= !empty(lang('cookie_privacy'))?lang('cookie_privacy'):"Cookies & Privacy";?></h3>
			...
			<!-- /.box-header -->
			<form action="<?= base_url('admin/dashboard/add_privacy') ?>" method="post" class="skill_form" enctype= "multipart/form-data">
				<div class="box-body">
