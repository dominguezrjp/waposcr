<html>
    ...
    <body style="min-height: 100vh;display: flex;align-items: center; justify-content: center;background: #fff;">
            ...
            <table class="table_data">
                <tbody>
                	...
                	<?php foreach ($item_list as $key => $row): ?>
	                    ...
	                    $discount = !empty($order_info['discount'])?$order_info['discount']:0;
                    ...
                    <tr style="margin-top: 10px;">
                        ...
                        <td class="total" style="text-align: right;"><?= isset($order_info['discount'])?currency_position($order_info['discount'],restaurant($id)->id):0;?> </td>
                    </tr>
